...
training_x <- read.table("~/UCI_HAR_Dataset/train/X_train.txt")
training_sub <- read.table("~/UCI_HAR_Dataset/train/subject_train.txt")
training_y <- read.table("~/UCI_HAR_Dataset/train/y_train.txt")
